...
i1 = DraggableItem(frameColor=(0.1, 1, .1, 1), text="1", scale=0.2, placementOffset=(0, -.05))
d1["content"] = i1
i2 = DraggableItem(frameColor=(0.1, 1, .1, 1), text="2", scale=0.2, placementOffset=(0, -.05))
d3["content"] = i2
...
i1 = DraggableItem(frameColor=(0.1, 1, .1, 1), text="1", scale=0.2, group=1, placementOffset=(0, -.05))
d1["content"] = i1
i2 = DraggableItem(frameColor=(0.1, 1, .1, 1), text="2", scale=0.2, group=1, placementOffset=(0, -.05))
d3["content"] = i2
