...
def init(base_np=None, respect_sortOrder=True, do_bug_fixes=False, theme=None, do_keyboard_navigation=True):
    ...
    """
    GuiController(base_np, respect_sortOrder, do_bug_fixes, theme, do_keyboard_navigation)
